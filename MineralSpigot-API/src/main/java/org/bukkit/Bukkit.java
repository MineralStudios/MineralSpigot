...
public final class Bukkit {
    ...
    public static String getVersionMessage() {
        final java.util.jar.Manifest manifest = io.papermc.paper.util.JarManifests
                .manifest(Bukkit.getServer().getClass());
        ...
        return "This server is running " + getName() + " version " + getVersion() + " (Implementing API version "
                + getBukkitVersion() + ") (Git: " + gitCommit + branchMsg + ")";
    }
    // PandaSpgiot end
    ...
    // PandaSpigot start
    /**
     * Returns the de facto plugins directory, generally used for storing plugin
     * jars to be loaded,
     * as well as their {@link org.bukkit.plugin.Plugin#getDataFolder() data
     * folders}.
     *
     * <p>
     * Plugins should use {@link org.bukkit.plugin.Plugin#getDataFolder()} rather
     * than traversing this
     * directory manually when determining the location in which to store their data
