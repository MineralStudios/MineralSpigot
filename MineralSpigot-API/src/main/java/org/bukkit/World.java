...
public interface World extends PluginMessageRecipient, Metadatable {
     ...
     *                                  Material} are null or {@link Material} is
     *                                  not a block
     * @deprecated Magic value
     */
    @Deprecated
    ...
    public class Spigot {
         ...
         *                                  It also throws when the effect requires a
         *                                  material or a material data
         */
    ...
    public enum Environment {
        ...
        private static final Int2ObjectOpenHashMap<Environment> lookup = new Int2ObjectOpenHashMap<>();
