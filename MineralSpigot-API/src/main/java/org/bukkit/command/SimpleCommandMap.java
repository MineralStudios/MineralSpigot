...
public class SimpleCommandMap implements CommandMap {
    ...
    protected final Map<String, Command> knownCommands = new Object2ObjectOpenHashMap<String, Command>();
    ...
    public boolean registerOverride(String label, Command command, boolean isAlias, String fallbackPrefix) {
    ...
    public boolean registerOverride(String label, String fallbackPrefix, Command command) {
        label = label.toLowerCase().trim();
        fallbackPrefix = fallbackPrefix.toLowerCase().trim();
        boolean registered = registerOverride(label, command, false, fallbackPrefix);
    ...
    public boolean dispatch(CommandSender sender, String commandLine) throws CommandException {
        ...
        try {
            ...
            server.getPluginManager()
                    .callEvent(new ServerExceptionEvent(new ServerCommandException(ex, target, sender, args))); // Paper
    ...
    public List<String> tabComplete(CommandSender sender, String cmdLine, Location location) {
        ...
        try {
            ...
            server.getPluginManager()
                    .callEvent(new ServerExceptionEvent(new ServerTabCompleteException(msg, ex, target, sender, args))); // Paper
            throw new CommandException(msg, ex);
        }
    }
    // PaperSpigot end
