...
public class PlayerItemConsumeEvent extends PlayerEvent implements Cancellable {
    ...
    /**
     * Return the custom item stack that will replace the consumed item, or null if
     * no
     * custom replacement has been set (which means the default replacement will be
     * used).
     */
