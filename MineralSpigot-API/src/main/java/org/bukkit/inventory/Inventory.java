...
public interface Inventory extends Iterable<ItemStack> {
     ...
     */
    public Int2ObjectOpenHashMap<ItemStack> addItem(ItemStack... items) throws IllegalArgumentException;
     ...
     */
    public Int2ObjectOpenHashMap<ItemStack> removeItem(ItemStack... items) throws IllegalArgumentException;
     ...
     */
    @Deprecated
    public Int2ObjectOpenHashMap<? extends ItemStack> all(int materialId);
     ...
     * @throws IllegalArgumentException if material is null
     */
    public Int2ObjectOpenHashMap<? extends ItemStack> all(Material material) throws IllegalArgumentException;
     ...
     */
    public Int2ObjectOpenHashMap<? extends ItemStack> all(ItemStack item);
