...
public final class JavaPluginLoader implements PluginLoader {
    ...
    public Map<Class<? extends Event>, Set<RegisteredListener>> createRegisteredListeners(Listener listener,
        ...
        Map<Class<? extends Event>, Set<RegisteredListener>> ret = new Object2ObjectOpenHashMap<Class<? extends Event>, Set<RegisteredListener>>();
        Set<Method> methods;
        try {
        ...
        for (final Method method : methods) {
            ...
            EventExecutor executor = new EventExecutor() { // Spigot
