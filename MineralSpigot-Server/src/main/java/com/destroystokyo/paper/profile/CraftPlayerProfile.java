...
public class CraftPlayerProfile implements PlayerProfile {
    ...
    public boolean completeFromCache() {
        return completeFromCache(false, GlobalConfig.getInstance().isProxyOnlineMode());
    }
    ...
    public boolean completeFromCache(boolean lookupUUID, boolean onlineMode) {
        ...
        if (profile.getId() == null) {
            ...
            if (profile != null) {
                // if old has it, assume its newer, so overwrite, else use cached if it was set
                // and ours wasn't
    ...
    public boolean complete(boolean textures) {
        MinecraftServer server = MinecraftServer.getServer();
        return complete(textures, GlobalConfig.getInstance().isProxyOnlineMode());
    }
