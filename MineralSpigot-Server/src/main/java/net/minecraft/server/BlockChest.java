...
public class BlockChest extends BlockContainer {
    ...
    public static final BlockStateDirection FACING = BlockStateDirection.of("facing",
            (Predicate) EnumDirection.EnumDirectionLimit.HORIZONTAL);
    public final int b;
    ...
    private boolean p(World world, BlockPosition blockposition) {
        ...
        if (GlobalConfig.getInstance().isDisableChestCatDetection()) {
            return false;
        }
        // PaperSpigot end
        Iterator iterator = world.a(EntityOcelot.class,
                new AxisAlignedBB((double) blockposition.getX(), (double) (blockposition.getY() + 1),
                        (double) blockposition.getZ(), (double) (blockposition.getX() + 1),
                        (double) (blockposition.getY() + 2), (double) (blockposition.getZ() + 1)))
                .iterator();
