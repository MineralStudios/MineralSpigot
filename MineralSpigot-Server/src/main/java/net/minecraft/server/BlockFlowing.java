...
public class BlockFlowing extends BlockFluids {
    ...
    private void f(World world, BlockPosition blockposition, IBlockData iblockdata) {
        world.setTypeAndData(blockposition,
                b(this.material).getBlockData().set(BlockFlowing.LEVEL, iblockdata.get(BlockFlowing.LEVEL)), 2);
    }
            ...
            if (this.a >= 2 && this.material == Material.WATER) {
                ...
                if (iblockdata1.getBlock().getMaterial().isBuildable()) {
                    i1 = 0;
                        ...
                        && ((Integer) iblockdata1.get(BlockFlowing.LEVEL)).intValue() == 0) {
                    i1 = 0;
                }
            }

            if (!GlobalConfig.getInstance().isFastDrainLava() && this.material == Material.LAVA && i < 8 && i1 < 8
                    && i1 > i && random.nextInt(4) != 0) { // PaperSpigot
                j *= 4;
            }
        ...
        while (iterator.hasNext()) {
            ...
            if (enumdirection1 != enumdirection) {
                ...
                if (!this.g(world, blockposition1, iblockdata) && (iblockdata.getBlock().getMaterial() != this.material
                        || ((Integer) iblockdata.get(BlockFlowing.LEVEL)).intValue() > 0)) {
    ...
    public int getFlowSpeed(World world, BlockPosition blockposition) {
        if (this.getMaterial() == Material.LAVA) {
            return world.worldProvider.o() ? GlobalConfig.getInstance().getLavaFlowSpeedNether()
                    : GlobalConfig.getInstance().getLavaFlowSpeedNormal();
        }
        if (this.getMaterial() == Material.WATER
            ...
            return GlobalConfig.getInstance().getWaterOverLavaFlowSpeed();
        }
    ...
    public boolean canFastDrain(World world, BlockPosition position) {
        ...
        if (this.material == Material.WATER) {
            if (GlobalConfig.getInstance().isFastDrainWater()) {
                result = true;
            ...
            if (GlobalConfig.getInstance().isFastDrainLava()) {
                result = true;
                if (getData(world, position.down()) < 0
