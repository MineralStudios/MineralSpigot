...
public class BlockPortal extends BlockHalfTransparent {
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        ...
        if (GlobalConfig.getInstance().isEnableZombiePigmenPortalSpawns() && world.worldProvider.d()
            ...
            for (blockposition1 = blockposition; !World.a((IBlockAccess) world, blockposition1)
            ...
            if (i > 0 && !world.getType(blockposition1.up()).getBlock().isOccluding()) {
                ...
                Entity entity = ItemMonsterEgg.spawnCreature(world, 57, (double) blockposition1.getX() + 0.5D,
                        (double) blockposition1.getY() + 1.1D, (double) blockposition1.getZ() + 0.5D,
    ...
    public void updateShape(IBlockAccess iblockaccess, BlockPosition blockposition) {
        EnumDirection.EnumAxis enumdirection_enumaxis = (EnumDirection.EnumAxis) iblockaccess.getType(blockposition)
