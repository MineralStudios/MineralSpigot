...
public class ChunkProviderGenerate implements IChunkProvider {
    ...
    public Chunk getOrCreateChunk(int i, int j) {
        ...
        if (this.r.r && GlobalConfig.getInstance().isGenerateCaves()) { // PaperSpigot
            this.u.a(this, this.m, i, j, chunksnapshot);
        }

        if (this.r.z && GlobalConfig.getInstance().isGenerateCanyon()) { // PaperSpigot
            this.z.a(this, this.m, i, j, chunksnapshot);
        }

        if (this.r.w && this.n && GlobalConfig.getInstance().isGenerateMineshaft()) { // PaperSpigot
            this.x.a(this, this.m, i, j, chunksnapshot);
        }

        if (this.r.v && this.n && GlobalConfig.getInstance().isGenerateVillage()) { // PaperSpigot
            this.w.a(this, this.m, i, j, chunksnapshot);
        }

        if (this.r.u && this.n && GlobalConfig.getInstance().isGenerateStronghold()) { // PaperSpigot
            this.v.a(this, this.m, i, j, chunksnapshot);
        }

        if (this.r.x && this.n && GlobalConfig.getInstance().isGenerateTemple()) { // PaperSpigot
            this.y.a(this, this.m, i, j, chunksnapshot);
        }

        if (this.r.y && this.n && GlobalConfig.getInstance().isGenerateMonument()) { // PaperSpigot
    ...
    public void getChunkAt(IChunkProvider ichunkprovider, int i, int j) {
        ...
        if (this.r.s && GlobalConfig.getInstance().isGenerateDungeon()) { // PaperSpigot
