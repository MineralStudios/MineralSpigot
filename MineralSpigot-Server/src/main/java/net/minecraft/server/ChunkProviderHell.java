...
public class ChunkProviderHell implements IChunkProvider {
        ...
        for (int l = 0; l < 16; ++l) {
            for (int i1 = 0; i1 < 16; ++i1) {
                ...
                for (int l1 = 127; l1 >= 0; --l1) {
                    ...
                    if (l1 < 127 - (GlobalConfig.getInstance().isGenerateFlatBedrock() ? 0 : this.j.nextInt(5)) &&
                            l1 > (GlobalConfig.getInstance().isGenerateFlatBedrock() ? 0 : this.j.nextInt(5))) {
                        // PaperSpigot end
    ...
    public Chunk getOrCreateChunk(int i, int j) {
        ...
        if (GlobalConfig.getInstance().isGenerateCaves())
            this.C.a(this, this.h, i, j, chunksnapshot); // PaperSpigot
        if (this.i && GlobalConfig.getInstance().isGenerateFortress()) { // PaperSpigot
    ...
    public void recreateStructures(Chunk chunk, int i, int j) {
        if (GlobalConfig.getInstance().isGenerateFortress())
