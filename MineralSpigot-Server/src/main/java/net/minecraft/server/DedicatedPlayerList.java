...
public class DedicatedPlayerList extends PlayerList {
    ...
    public DedicatedPlayerList(DedicatedServer dedicatedserver) {
        ...
        this.a(GlobalConfig.getInstance().getViewDistance());
        this.maxPlayers = GlobalConfig.getInstance().getMaxPlayers();
        this.setHasWhitelist(GlobalConfig.getInstance().isWhitelist());
