...
public abstract class Entity implements ICommandListener {
    ...
    public void setSize(float f, float f1) {
        if (f != this.width || f1 != this.length) {
            ...
            this.a(new AxisAlignedBB(this.getBoundingBox().a, this.getBoundingBox().b, this.getBoundingBox().c,
                    this.getBoundingBox().a + (double) this.width, this.getBoundingBox().b + (double) this.length,
                    this.getBoundingBox().c + (double) this.width));
    ...
    public void setPosition(double d0, double d1, double d2) {
        ...
        this.a(new AxisAlignedBB(d0 - (double) f, d1, d2 - (double) f, d0 + (double) f, d1 + (double) f1,
                d2 + (double) f));
    }
    ...
    private boolean paperNetherCheck() {
        return GlobalConfig.getInstance().isNetherVoidTopDamage()
    ...
    public void move(double d0, double d1, double d2) {
        ...
        if (this.noclip) {
            ...
            // PandaSpigot start - do axis by axis scan if the entity is travelling a large
            // area
            ...
            boolean axisScan = GlobalConfig.getInstance().isOptimizeTntMovement() && xLenght * yLenght * zLenght > 10;
            ...
            for (Iterator iterator = list.iterator(); iterator
                    .hasNext(); d1 = axisalignedbb1.b(this.getBoundingBox(), d1)) {
            ...
            if (axisScan)
                list = this.world.getCubes(this, this.getBoundingBox().a(d0, 0, 0)); // PandaSpigot - get x axis blocks
            ...
            if (axisScan)
                list = this.world.getCubes(this, this.getBoundingBox().a(0, 0, d2)); // PandaSpigot - get z axis blocks
    ...
    public boolean U() {
        return this.inWater || this.world.isRainingAt(new BlockPosition(this.locX, this.locY, this.locZ))
                || this.world.isRainingAt(new BlockPosition(this.locX, this.locY + (double) this.length, this.locZ));
    }
    ...
    protected void X() {
        ...
        for (i = 0; (float) i < 1.0F + this.width * 20.0F; ++i) {
            ...
            this.world.addParticle(EnumParticle.WATER_BUBBLE, this.locX + (double) f2, (double) (f1 + 1.0F),
                    this.locZ + (double) f3, this.motX, this.motY - (double) (this.random.nextFloat() * 0.2F),
                    this.motZ, new int[0]);
        }
        ...
        for (i = 0; (float) i < 1.0F + this.width * 20.0F; ++i) {
            f2 = (this.random.nextFloat() * 2.0F - 1.0F) * this.width;
            f3 = (this.random.nextFloat() * 2.0F - 1.0F) * this.width;
            this.world.addParticle(EnumParticle.WATER_SPLASH, this.locX + (double) f2, (double) (f1 + 1.0F),
                    this.locZ + (double) f3, this.motX, this.motY, this.motZ, new int[0]);
        }
    ...
    public float c(float f) {
        BlockPosition blockposition = new BlockPosition(this.locX, this.locY + (double) this.getHeadHeight(),
                this.locZ);
    ...
    public void setPositionRotation(BlockPosition blockposition, float f, float f1) {
        this.setPositionRotation((double) blockposition.getX() + 0.5D, (double) blockposition.getY(),
                (double) blockposition.getZ() + 0.5D, f, f1);
    }
        ...
        if (this.noclip) {
            ...
            for (int i = 0; i < 8; ++i) {
                int j = MathHelper.floor(
                        this.locY + (double) (((float) ((i >> 0) % 2) - 0.5F) * 0.1F) + (double) this.getHeadHeight());
    ...
    public void ak() {
        if (this.vehicle.dead) {
            ...
            if (this.vehicle != null) {
                ...
                for (this.ar += (double) (this.vehicle.pitch
        ...
        if (entity == null) {
            if (this.vehicle != null) {
                ...
                this.setPositionRotation(this.vehicle.locX,
                        this.vehicle.getBoundingBox().b + (double) this.vehicle.length, this.vehicle.locZ, this.yaw,
                        this.pitch);
            ...
            if ((this.bukkitEntity instanceof LivingEntity) && (entity.getBukkitEntity() instanceof Vehicle)
                ...
                if (event.isCancelled() || this.vehicle != originalVehicle
                    ...
                    if (exitEvent != null && this.vehicle == originalVehicle && this.vehicle != null
                        ...
                        this.setPositionRotation(this.vehicle.locX,
                                this.vehicle.getBoundingBox().b + (double) this.vehicle.length, this.vehicle.locZ,
                                this.yaw, this.pitch);
                        this.vehicle.passenger = null;
                        this.vehicle = null;
                    }
        ...
        if (this.portalCooldown > 0) {
            ...
            if (!this.world.isClientSide && !blockposition.equals(this.an)) {
                ...
                d1 = Math.abs(MathHelper.c(
                        d1 - (double) (shapedetector_shapedetectorcollection.b().e()
                                .c() == EnumDirection.EnumAxisDirection.NEGATIVE ? 1 : 0),
                        d0, d0 - (double) shapedetector_shapedetectorcollection.d()));
                double d2 = MathHelper.c(this.locY - 1.0D, (double) shapedetector_shapedetectorcollection.a().getY(),
