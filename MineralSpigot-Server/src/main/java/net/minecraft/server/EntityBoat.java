...
public class EntityBoat extends Entity {
    ...
    public void t_() {
        ...
        for (int i = 0; i < b0; ++i) {
            double d1 = this.getBoundingBox().b
                    + (this.getBoundingBox().e - this.getBoundingBox().b) * (double) (i + 0) / (double) b0 - 0.125D;
            double d2 = this.getBoundingBox().b
                    + (this.getBoundingBox().e - this.getBoundingBox().b) * (double) (i + 1) / (double) b0 - 0.125D;
        ...
        if (this.world.isClientSide && this.a) {
            ...
            if (this.passenger instanceof EntityLiving) {
                ...
                this.motX += -Math.sin((double) (f * 3.1415927F / 180.0F)) * this.b * (double) entityliving.ba
                        * 0.05000000074505806D;
                this.motZ += Math.cos((double) (f * 3.1415927F / 180.0F)) * this.b * (double) entityliving.ba
                        * 0.05000000074505806D;
            }
    ...
    public void breakNaturally() {
        if (GlobalConfig.getInstance().isBoatsDropBoats()) {
            this.a(Items.BOAT, 1, 0.0F);
        } else {
            for (int k = 0; k < 3; ++k) {
