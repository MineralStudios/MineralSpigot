...
public class EntityEnderDragon extends EntityInsentient implements IComplex, IMonster {
    ...
    public void m() {
        ...
        if (this.getHealth() <= 0.0F) {
            ...
            this.world.addParticle(EnumParticle.EXPLOSION_LARGE, this.locX + (double) f, this.locY + 2.0D + (double) f1,
                    this.locZ + (double) f2, 0.0D, 0.0D, 0.0D, new int[0]);
        } else {
            this.n();
            ...
            if (this.ce()) {
                ...
                if (this.world.isClientSide) {
                    ...
                    Vec3D vec3d1 = (new Vec3D((double) MathHelper.sin(this.yaw * 3.1415927F / 180.0F), this.motY, d4))
                            .a();
                ...
                this.bo.t_();
                this.bo.setPositionRotation(this.locX + (double) (f11 * 0.5F), this.locY,
                        this.locZ - (double) (f12 * 0.5F), 0.0F, 0.0F);
                this.bs.t_();
                this.bs.setPositionRotation(this.locX + (double) (f12 * 4.5F), this.locY + 2.0D,
                        this.locZ + (double) (f11 * 4.5F), 0.0F, 0.0F);
                this.bt.t_();
                this.bt.setPositionRotation(this.locX - (double) (f12 * 4.5F), this.locY + 2.0D,
                        this.locZ - (double) (f11 * 4.5F), 0.0F, 0.0F);
                ...
                this.bn.t_();
                this.bn.setPositionRotation(this.locX + (double) (f3 * 5.5F * f2),
    ...
    private void n() {
        ...
        if (this.random.nextInt(10) == 0) {
            ...
            List list = this.world.a(EntityEnderCrystal.class,
                    this.getBoundingBox().grow((double) f, (double) f, (double) f));
    ...
    protected void aZ() {
        ...
        if (this.by >= 180 && this.by <= 200) {
            ...
            this.world.addParticle(EnumParticle.EXPLOSION_HUGE, this.locX + (double) f, this.locY + 2.0D + (double) f1,
                    this.locZ + (double) f2, 0.0D, 0.0D, 0.0D, new int[0]);
        }
        ...
        if (!this.world.isClientSide) {
            ...
            if (this.by == 1) {
                ...
                for (EntityPlayer player : (List<EntityPlayer>) MinecraftServer.getServer().getPlayerList().players) {
                    ...
                    if (GlobalConfig.getInstance().getDragonDeathSoundRadius() > 0
                            && distanceSquared > GlobalConfig.getInstance().getDragonDeathSoundRadius()
                                    * GlobalConfig.getInstance().getDragonDeathSoundRadius())
                        continue; // Spigot
