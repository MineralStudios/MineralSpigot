...
public abstract class EntityInsentient extends EntityLiving {
    ...
    protected void a(EntityItem entityitem) {
        ...
        if (i > -1) {
            ...
            org.bukkit.event.entity.EntityPickupItemEvent entityEvent = new org.bukkit.event.entity.EntityPickupItemEvent(
                    ...
                    (org.bukkit.entity.Item) entityitem.getBukkitEntity(), 0);
    ...
    protected void D() {
        if (this.persistent) {
            ...
            if (entityhuman != null) {
                ...
                if (d3 > GlobalConfig.getInstance().getHardDespawnDistance()) { // CraftBukkit - remove
                    // isTypeNotPersistent() check //
                    // PaperSpigot - custom despawn distances
                    this.die();
                }

                if (this.ticksFarFromPlayer > 600 && this.random.nextInt(800) == 0
                        && d3 > GlobalConfig.getInstance().getSoftDespawnDistance()) { // CraftBukkit - remove
                    // isTypeNotPersistent() check //
                    // PaperSpigot - custom despawn
                    // distance
                    this.die();
                } else if (d3 < GlobalConfig.getInstance().getSoftDespawnDistance()) { // PaperSpigot - custom despawn
                    // distances
                    this.ticksFarFromPlayer = 0;
                }
            }
    ...
    protected final void doTick() {
        ...
        this.world.methodProfiler.b();
        // Spigot Start
        if (GlobalConfig.getInstance().isDisableEntityAi() || this.fromMobSpawner) // PandaSpigot - configurable entity
                                                                                   // AI
        {
        ...
        if (this.bo) {
            ...
            if (!this.world.isClientSide && flag && this.world instanceof WorldServer) {
                ((WorldServer) this.world).getTracker().a((Entity) this,
                        (Packet) (new PacketPlayOutAttachEntity(1, this, (Entity) null)));
            }
        }
    ...
    public void setLeashHolder(Entity entity, boolean flag) {
        ...
        if (!this.world.isClientSide && flag && this.world instanceof WorldServer) {
            ((WorldServer) this.world).getTracker().a((Entity) this,
                    (Packet) (new PacketPlayOutAttachEntity(1, this, this.bp)));
        }
