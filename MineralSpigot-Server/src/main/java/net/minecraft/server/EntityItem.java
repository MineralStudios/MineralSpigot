...
public class EntityItem extends Entity {
    ...
    public EntityHuman lastHolder;

    public EntityItem(World world, double d0, double d1, double d2, ItemStack itemstack, EntityHuman lastHolder) {
    ...
    public void t_() {
        if (this.getItemStack() == null) {
            ...
            this.W();
            if (!this.world.isClientSide && this.age >= GlobalConfig.getInstance().getItemDespawnRate()) { // Spigot
    ...
    private void w() {
        double radius = GlobalConfig.getInstance().getItemMerge();

        for (EntityItem entityitem : this.world
                .a(EntityItem.class, this.getBoundingBox().grow(radius, radius, radius)))
            this.a(entityitem);
    }
    ...
    public void d(EntityHuman entityhuman) {
        if (!this.world.isClientSide) {
            ...
            if (this.pickupDelay <= 0 && canHold > 0) {
                ...
                // itemstack.count = canHold + remaining; // PandaSpigot - move down after new
                // event
                ...
                org.bukkit.event.entity.EntityPickupItemEvent entityEvent = new org.bukkit.event.entity.EntityPickupItemEvent(
                        entityhuman.getBukkitEntity(), (org.bukkit.entity.Item) this.getBukkitEntity(), remaining);
                // event.setCancelled(!entityhuman.canPickUpLoot); TODO
