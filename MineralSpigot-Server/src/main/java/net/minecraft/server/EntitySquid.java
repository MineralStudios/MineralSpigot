...
public class EntitySquid extends EntityWaterAnimal {
    ...
    public EntitySquid(World world) {
        ...
        // this.random.setSeed((long) (1 + this.getId())); // PandaSpigot - shared
        // random
     ...
     * public boolean V() {
     * return this.world.a(this.getBoundingBox().grow(0.0D, -0.6000000238418579D,
     * 0.0D), Material.WATER, (Entity) this);
     * }
     * // CraftBukkit end
     */
    ...
    public boolean bR() {
        ...
        return this.locY > GlobalConfig.getInstance().getSquidMinSpawnHeight()
                && this.locY < (double) GlobalConfig.getInstance().getSquidMaxSpawnHeight() && super.bR();
    }
