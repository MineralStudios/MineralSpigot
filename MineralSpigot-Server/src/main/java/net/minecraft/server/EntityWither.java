    ...
    public void m() {
        ...
        for (j = 0; j < 3; ++j) {
            ...
            this.world.addParticle(EnumParticle.SMOKE_NORMAL, d8 + this.random.nextGaussian() * 0.30000001192092896D,
                    ...
                    d10 + this.random.nextGaussian() * 0.30000001192092896D, 0.0D, 0.0D, 0.0D, new int[0]);
        ...
        if (this.cl() > 0) {
            ...
            if (i <= 0) {
                ...
                for (EntityPlayer player : (List<EntityPlayer>) MinecraftServer.getServer().getPlayerList().players) {
                    ...
                    if (GlobalConfig.getInstance().getWitherSpawnSoundRadius() > 0
                            && distanceSquared > GlobalConfig.getInstance().getWitherSpawnSoundRadius()
                                    * GlobalConfig.getInstance().getWitherSpawnSoundRadius())
                        continue; // Spigot
