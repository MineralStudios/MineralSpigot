...
public final class ItemStack {
    ...
    public void setData(int i) {
        ...
        if (CraftMagicNumbers.getBlock(id) != Blocks.AIR) {
            ...
            boolean allowedItemsNull = GlobalConfig.getInstance().getDataValueAllowedItems() == null;

            boolean containsId = false;
            if (!allowedItemsNull) {
                for (int allowedId : GlobalConfig.getInstance().getDataValueAllowedItems()) {
                    if (allowedId == id) {
                        containsId = true;
                        break;
                    }
    ...
    private boolean d(ItemStack itemstack) {
        return this.count != itemstack.count ? false
                : (this.item != itemstack.item ? false
                        : (this.damage != itemstack.damage ? false
                                : (this.tag == null && itemstack.tag != null ? false
                                        : this.tag == null || this.tag.equals(itemstack.tag))));
    }
