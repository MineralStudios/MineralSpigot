...
public abstract class MobSpawnerAbstract {
    ...
    public void c() {
        ...
        if (spawnDelay > 0 && --tickDelay > 0)
            return;
        tickDelay = GlobalConfig.getInstance().getMobSpawnerTickRate();
        // PaperSpigot end
        if (this.g()) {
            BlockPosition blockposition = this.b();
            double d0;
            ...
            if (this.a().isClientSide) {
                ...
                for (int i = 0; i < this.spawnCount; ++i) {
                    ...
                    if (net.techcable.tacospigot.event.entity.SpawnerPreSpawnEvent.getHandlerList()
                            .getRegisteredListeners().length > 0) {
                        net.techcable.tacospigot.event.entity.SpawnerPreSpawnEvent event = new net.techcable.tacospigot.event.entity.SpawnerPreSpawnEvent(
                                new org.bukkit.Location(this.a().getWorld(), blockposition.getX(), blockposition.getY(),
                                        blockposition.getZ()),
                                org.bukkit.entity.EntityType.fromName(this.getMobName()));
                        if (!event.callEvent()) {
                            flag = true;
                            break;
                        }
                    ...
                    int j = this.a().a(entity.getClass(),
                            (new AxisAlignedBB((double) blockposition.getX(), (double) blockposition.getY(),
                                    ...
                                    .grow((double) this.spawnRange, (double) this.spawnRange, (double) this.spawnRange))
                            .size();
        ...
        if (this.i() != null) {
            ...
            if (entity.world != null && flag) {
                ...
                if (!event.isCancelled()) {
                    ...
                    // Spigot Start
                    if (GlobalConfig.getInstance().isNerfSpawnerMobs()) {
    ...
    public void a(NBTTagCompound nbttagcompound) {
        ...
        if (nbttagcompound.hasKeyOfType("SpawnData", 10)) {
            this.a(new MobSpawnerAbstract.TileEntityMobSpawnerData(nbttagcompound.getCompound("SpawnData"),
                    this.mobName));
        } else {
        ...
        if (!UtilColor.b(s)) {
            ...
            if (this.i() != null || this.mobs.size() > 0) {
                ...
                if (this.mobs.size() > 0) {
                    ...
                    while (iterator.hasNext()) {
                        MobSpawnerAbstract.TileEntityMobSpawnerData mobspawnerabstract_tileentitymobspawnerdata = (MobSpawnerAbstract.TileEntityMobSpawnerData) iterator
                                .next();
