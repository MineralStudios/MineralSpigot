...
public class PacketPlayOutMultiBlockChange implements Packet<PacketListenerPlayOut> {
    ...
    public void a(PacketDataSerializer packetdataserializer) throws IOException {
        ...
        for (int i = 0; i < this.b.length; ++i) {
            this.b[i] = new PacketPlayOutMultiBlockChange.MultiBlockChangeInfo(packetdataserializer.readShort(),
                    (IBlockData) Block.d.a(packetdataserializer.e()));
        }
    ...
    public class MultiBlockChangeInfo {
        ...
        public BlockPosition a() {
            return new BlockPosition(
                    PacketPlayOutMultiBlockChange.this.a.a(this.b >> 12 & 15, this.b & 255, this.b >> 8 & 15));
        }
