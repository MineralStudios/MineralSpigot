...
public class PacketPlayOutUpdateAttributes implements Packet<PacketListenerPlayOut> {
    ...
    public PacketPlayOutUpdateAttributes(int i, Collection<AttributeInstance> collection) {
        ...
        while (iterator.hasNext()) {
            ...
            this.b.add(new PacketPlayOutUpdateAttributes.AttributeSnapshot(attributeinstance.getAttribute().getName(),
                    attributeinstance.b(), attributeinstance.c()));
        }
        ...
        for (int j = 0; j < i; ++j) {
            ...
            for (int l = 0; l < k; ++l) {
                ...
                arraylist.add(new AttributeModifier(uuid, "Unknown synced attribute modifier",
                        packetdataserializer.readDouble(), packetdataserializer.readByte()));
            }
    ...
    public void b(PacketDataSerializer packetdataserializer) throws IOException {
        ...
        while (iterator.hasNext()) {
            PacketPlayOutUpdateAttributes.AttributeSnapshot packetplayoutupdateattributes_attributesnapshot = (PacketPlayOutUpdateAttributes.AttributeSnapshot) iterator
                    .next();
