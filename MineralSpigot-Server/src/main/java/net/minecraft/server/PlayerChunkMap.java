...
public class PlayerChunkMap {
    ...
    private final Long2ObjectOpenHashMap<PlayerChunkMap.PlayerChunk> d = new Long2ObjectOpenHashMap<>();
    private final Queue<PlayerChunkMap.PlayerChunk> e = new java.util.concurrent.ConcurrentLinkedQueue<PlayerChunkMap.PlayerChunk>(); // CraftBukkit
                                                                                                                                      // ArrayList
                                                                                                                                      // ->
                                                                                                                                      // ConcurrentLinkedQueue
    private final Queue<PlayerChunkMap.PlayerChunk> f = new java.util.concurrent.ConcurrentLinkedQueue<PlayerChunkMap.PlayerChunk>(); // CraftBukkit
                                                                                                                                      // ArrayList
                                                                                                                                      // ->
                                                                                                                                      // ConcurrentLinkedQueue
    private int g;
    ...
    public boolean a(EntityPlayer entityplayer, int i, int j) {
        ...
        return playerchunkmap_playerchunk != null && playerchunkmap_playerchunk.b.contains(entityplayer)
                && !entityplayer.chunkCoordIntPairQueue.contains(playerchunkmap_playerchunk.location);
    }
    ...
    class PlayerChunk {
        ...
        public void a(final EntityPlayer entityplayer) { // CraftBukkit - added final to argument
            if (this.b.contains(entityplayer)) {
                PlayerChunkMap.a.debug("Failed to add player. {} already is in chunk {}, {}", new Object[] {
                        entityplayer, Integer.valueOf(this.location.x), Integer.valueOf(this.location.z) });
            } else {
                if (this.b.isEmpty()) {
            ...
            if (this.dirtyCount != 0) {
                ...
                if (this.dirtyCount == 1) {
                    ...
                    if (this.dirtyCount == 64) {
                        ...
                        this.a((Packet) (new PacketPlayOutMapChunk(
                                PlayerChunkMap.this.world.getChunkAt(this.location.x, this.location.z), false,
                                this.f)));
                        ...
                        this.a((Packet) (new PacketPlayOutMultiBlockChange(this.dirtyCount, this.dirtyBlocks,
