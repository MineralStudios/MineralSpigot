...
public class PlayerInteractManager {
    ...
    public void a(BlockPosition blockposition, EnumDirection enumdirection) {
        ...
        if (event.isCancelled()) {
            ...
            ((EntityPlayer) this.player).playerConnection
        ...
        if (this.isCreative()) {
            ...
            if (event.useInteractedBlock() == Event.Result.DENY) {
                ...
                if (block == Blocks.WOODEN_DOOR) {
                    ...
                    ((EntityPlayer) this.player).playerConnection
                            .sendPacket(new PacketPlayOutBlockChange(this.world, blockposition));
                    ((EntityPlayer) this.player).playerConnection.sendPacket(new PacketPlayOutBlockChange(this.world,
    ...
    public boolean interact(EntityHuman entityhuman, World world, ItemStack itemstack, BlockPosition blockposition,
         ...
         * entityhuman, enumdirection, f, f1, f2)) {
         * return true;
         * }
         * }
         * 
         ...
         * boolean flag = itemstack.placeItem(entityhuman, world, blockposition,
         ...
         * return flag;
         * } else {
         * return itemstack.placeItem(entityhuman, world, blockposition, enumdirection,
         * f, f1, f2);
         * }
         * }
         * // Interract event
