...
public class RecipesFurnace {
    ...
    public Map<ItemStack, ItemStack> recipes = new Object2ObjectOpenHashMap<>();
    private Object2FloatOpenHashMap<ItemStack> c = new Object2FloatOpenHashMap<>();
    public Map customRecipes = new Object2ObjectOpenHashMap<>();
    ...
    public float b(ItemStack itemstack) {
        val iterator = this.c.object2FloatEntrySet().iterator();

        it.unimi.dsi.fastutil.objects.Object2FloatMap.Entry<ItemStack> entry;
