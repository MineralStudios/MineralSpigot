...
public class Scoreboard {
    ...
    private final Map<String, ScoreboardObjective> objectivesByName = new Object2ObjectOpenHashMap<>();
    private final Map<IScoreboardCriteria, List<ScoreboardObjective>> objectivesByCriteria = new Object2ObjectOpenHashMap<>();
    private final Map<String, Map<ScoreboardObjective, ScoreboardScore>> playerScores = new Object2ObjectOpenHashMap<>();
    private final ScoreboardObjective[] displaySlots = new ScoreboardObjective[19];
    private final Map<String, ScoreboardTeam> teamsByName = new Object2ObjectOpenHashMap<>();
    private final Map<String, ScoreboardTeam> teamsByPlayer = new Object2ObjectOpenHashMap<>();
    ...
    public ScoreboardObjective registerObjective(String s, IScoreboardCriteria iscoreboardcriteria) {
        if (s.length() > 16) {
            ...
            if (scoreboardobjective != null) {
                ...
                List<ScoreboardObjective> list = this.objectivesByCriteria.computeIfAbsent(iscoreboardcriteria,
    ...
    public ScoreboardScore getPlayerScoreForObjective(String s, ScoreboardObjective scoreboardobjective) {
        if (s.length() > 40) {
            ...
            Map<ScoreboardObjective, ScoreboardScore> map = this.playerScores.computeIfAbsent(s,
    ...
    public Map<ScoreboardObjective, ScoreboardScore> getPlayerObjectives(String s) {
        var object = this.playerScores.get(s);

        if (object == null) {
            object = new Object2ObjectOpenHashMap<>();
        }
