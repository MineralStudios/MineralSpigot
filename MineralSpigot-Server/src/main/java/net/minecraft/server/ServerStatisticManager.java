...
public class ServerStatisticManager extends StatisticManager {
    ...
    public ServerStatisticManager(MinecraftServer minecraftserver, File file) {
        ...
        this.d = file;
        // Spigot start
        for (String name : GlobalConfig.getInstance().getForcedStats().keySet()) {
            StatisticWrapper wrapper = new StatisticWrapper();
            wrapper.a(GlobalConfig.getInstance().getForcedStats().getInt(name));
    ...
    public void b() {
        if (GlobalConfig.getInstance().isDisableStatSaving())
            return; // Spigot
        try {
    ...
    public void a(EntityPlayer entityplayer) {
        int i = this.c.at();
        Object2IntOpenHashMap<Statistic> hashmap = new Object2IntOpenHashMap<Statistic>();
