...
public class WorldGenVillage extends StructureGenerator {
    ...
    protected boolean a(int i, int j) {
        ...
        int i1 = i / this.g;
        int j1 = j / this.g;
        Random random = this.c.a(i1, j1, GlobalConfig.getInstance().getVillageSeed()); // Spigot
    ...
    public static class WorldGenVillageStart extends StructureStart {
        ...
        public WorldGenVillageStart(World world, Random random, int i, int j, int k) {
            ...
            worldgenvillagepieces_worldgenvillagestartpiece
                    .a((StructurePiece) worldgenvillagepieces_worldgenvillagestartpiece, (List) this.a, random);
            ...
            while (!list1.isEmpty() || !list2.isEmpty()) {
                ...
                if (list1.isEmpty()) {
                    ...
                    structurepiece.a((StructurePiece) worldgenvillagepieces_worldgenvillagestartpiece, (List) this.a,
                            random);
                } else {
