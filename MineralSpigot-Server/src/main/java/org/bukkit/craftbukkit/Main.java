...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (System.getProperty("jdk.nio.maxCachedBufferSize") == null)
            System.setProperty("jdk.nio.maxCachedBufferSize", "262144"); // PandaSpigot - cap per-thread NIO cache size
        ...
        if ((options == null) || (options.has("?"))) {
            ...
            try {
                 ...
                 * {'j','l','i','n','e','.','U','n','s','u','p','p','o','r','t','e','d','T','e',
                 * 'r','m','i','n','a','l'});
                 ...
                 * } else {
                 * // This ensures the terminal literal will always match the jline
                 * implementation
                 * System.setProperty(jline.TerminalFactory.JLINE_TERMINAL,
                 * jline.UnsupportedTerminal.class.getName());
                 * }
                 */
