...
public class CraftEventFactory {
    ...
    public static PlayerInteractEvent callPlayerInteractEvent(EntityHuman who, Action action, ItemStack itemstack) {
        ...
        return callPlayerInteractEvent(who, action, null, EnumDirection.SOUTH, itemstack); // PandaSpigot - SPIGOT-2380
                                                                                           // - Change BlockPosition to
                                                                                           // null
    }
    ...
    public static PlayerInteractEvent callPlayerInteractEvent(EntityHuman who, Action action, BlockPosition position,
        ...
        // Block blockClicked = craftWorld.getBlockAt(position.getX(), position.getY(),
        // position.getZ()); // PandaSpigot - move down
    ...
    // PandaSpigot start
    public static com.destroystokyo.paper.event.entity.ProjectileCollideEvent callProjectileCollideEvent(Entity entity,
            MovingObjectPosition position) {
        Projectile projectile = (Projectile) entity.getBukkitEntity();
        org.bukkit.entity.Entity collided = position.entity.getBukkitEntity();
        com.destroystokyo.paper.event.entity.ProjectileCollideEvent event = new com.destroystokyo.paper.event.entity.ProjectileCollideEvent(
                projectile, collided);
        Bukkit.getPluginManager().callEvent(event);
        return event;
    }
    ...
    public static ProjectileHitEvent callProjectileHitEvent(Entity entity, MovingObjectPosition position) {
        ...
        ProjectileHitEvent event = new ProjectileHitEvent((Projectile) entity.getBukkitEntity(), hitEntity, hitBlock,
                hitFace);
        // PandaSpigot end
