...
public class ActivationRange {
    ...
    public static boolean initializeEntityActivationState(Entity entity) {
        if ((entity.activationType == 3 && GlobalConfig.getInstance().getMiscActivationRange() == 0)
                || (entity.activationType == 2 && GlobalConfig.getInstance().getAnimalActivationRange() == 0)
                || (entity.activationType == 1 && GlobalConfig.getInstance().getMonsterActivationRange() == 0)
    ...
    public static void activateEntities(World world) {
        final int miscActivationRange = GlobalConfig.getInstance().getMiscActivationRange();
        final int animalActivationRange = GlobalConfig.getInstance().getAnimalActivationRange();
        final int monsterActivationRange = GlobalConfig.getInstance().getMonsterActivationRange();

        int maxRange = Math.max(monsterActivationRange, animalActivationRange);
        maxRange = Math.max(maxRange, miscActivationRange);
        maxRange = Math.min((GlobalConfig.getInstance().getViewDistance() << 4) - 8, maxRange);
